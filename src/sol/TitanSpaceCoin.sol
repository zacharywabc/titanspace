...
contract ERC20 is IERC20, Ownable {
    ...
    uint256 constant public MAX_TOTAL_SUPPLY = 1200000000e6;
    ...
    function _issue(address account, uint256 amount) internal {
        ...
        _totalIssued = _totalIssued.add(amount);
        require(_totalIssued <= MAX_TOTAL_SUPPLY, "CoinFactory: issue than MAX_TOTAL_SUPPLY");
...
contract TSpaceCoin is ERC20, ERC20Pausable, CoinFactory, Blacklist {
